...
class TestRedirects(Base):
    ...
    _winxp_products = [
        ...
        '38.6.3esr',
        '40.0.0esr',
        pytest.mark.xfail(reason='bug 1351879')('stub'),
        pytest.mark.xfail(reason='bug 1351879')('latest'),
        pytest.mark.xfail(reason='bug 1351879')('sha1'),
        pytest.mark.xfail(reason='bug 1351879')('42.0'),
        pytest.mark.xfail(reason='bug 1351879')('43.0.1'),
        pytest.mark.xfail(reason='bug 1351879')('44.0'),
        pytest.mark.xfail(reason='bug 1351879')('beta'),
        'beta-latest',
        '49.0b8',
        '49.0b10',
        '49.0b37'
