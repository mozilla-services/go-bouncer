...
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (2,'firefox-latest-ssl','Firefox-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (3,'firefox-beta-stub','Firefox-stub');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (4,'firefox-beta-latest','Firefox');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (5,'firefox-beta-latest-ssl','Firefox-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (6,'firefox-devedition-stub','Firefox-stub');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (7,'firefox-devedition-latest','Devedition-128.0b1');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (8,'firefox-devedition-latest-ssl','Devedition-128.0b1-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (9,'firefox-devedition-msi-latest-ssl','Firefox-132.0b9-msi-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (10,'partner-firefox-release-unitedinternet-foo-latest','Firefox-partner-unitedinternet-foo');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (11,'thunderbird-latest-ssl','Thunderbird-131.0.1-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (12,'firefox-esr-latest-ssl','Firefox-128.3.1esr-SSL');
INSERT INTO `mirror_aliases` (`id`, `alias`, `related_product`) VALUES (13,'firefox-esr-msi-latest-ssl','Firefox-115.16.1esr-msi-SSL');
...
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-115.16.1esr-SSL',1,1,1,20,1);
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-131.0.3-msi-SSL',1,1,1,21,1);
...
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-128.3.1esr-SSL',1,1,1,24,1);
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-132.0b9-msi-SSL',1,1,1,25,1);
