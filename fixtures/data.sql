...
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/win64/:lang/Firefox%20Setup%20126.0.1.exe',4,1,10);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/mac/:lang/Firefox%20Setup%20126.0.1.exe',4,2,11);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/win32/:lang/Firefox%20Setup%20126.0.1.exe',4,3,12);

INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/win64/:lang/Firefox%20Setup%20126.0.1.exe',5,1,10);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/mac/:lang/Firefox%20Setup%20126.0.1.exe',5,2,11);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/126.0.1/win32/:lang/Firefox%20Setup%20126.0.1.exe',5,3,12);

INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/127.0b4/win64/:lang/Firefox%20Setup%20127.0b4.exe',6,1,16);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/127.0b4/mac/:lang/Firefox%20Setup%20127.0b4.exe',6,2,17);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/releases/127.0b4/win32/:lang/Firefox%20Setup%20127.0b4.exe',6,3,18);

INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/nightly/latest-mozilla-central-l10n/firefox-128.0a1.:lang.win64.installer.exe',7,1,19);
INSERT INTO `mirror_locations` (`path`, `product_id`, `os_id`, `id`) VALUES ('/firefox/nightly/latest-mozilla-central-l10n/firefox-128.0a1.:lang.win32.installer.exe',7,3,20);
...
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-126.0.1',1,1,1,4,0);
INSERT INTO `mirror_products` (`count`, `name`, `checknow`, `priority`, `active`, `id`, `ssl_only`) VALUES (0,'Firefox-126.0.1-SSL',1,1,1,5,1);
